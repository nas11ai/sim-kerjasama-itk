...
class ReviewSummary extends Model
{
    protected $fillable = [
        ...
        'status',
        'summary_notes',
        'is_auto_generated', // NEW: Flag for auto-generated summaries from evaluations
    ];
    ...
    {
        if (!$this->is_auto_generated || !$this->reviewer_id) {
            return false;
        }
    ...
    // NEW: Check if this summary can be manually edited
    public function canBeManuallyEdited(): bool
    {
        return !$this->is_auto_generated;
    }

    // NEW: Convert auto-generated summary to manual for editing
    public function convertToManual(): bool
    {
        if (!$this->is_auto_generated) {
            return false;
        }

        return $this->update(['is_auto_generated' => false]);
    }
