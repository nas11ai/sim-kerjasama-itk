...
import Select from './ui/select/UiSelect.vue/index.js'
...
:model-value="`${table.getState().pagination.pageSize}`"
                    ...
                    <SelectContent side="top">
                        <SelectItem
v-for="pageSize in pageSizes || [10, 15, 20, 25, 50, 100]" :key="pageSize"
                            :value="`${pageSize}`">
                            {{ pageSize }}
                        </SelectItem>
                    </SelectContent>
...
variant="outline" class="h-8 w-8 p-0" :disabled="!table.getCanPreviousPage()"
                    ...
                    <Button
variant="outline" class="h-8 w-8 p-0" :disabled="!table.getCanNextPage()"
