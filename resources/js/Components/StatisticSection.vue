          ...
          <template v-else>
            ...
            <div>
              ...
              <div class="space-y-2">
                ...
                <div
                  v-if="!formPhase.formPhaseByPeriod || formPhase.formPhaseByPeriod.length === 0"
          ...
          <template v-else>
            ...
            <div>
              ...
              <div class="space-y-2">
                ...
                <div
                  v-if="!formSubmission.recentSubmissions || formSubmission.recentSubmissions.length === 0"
                  class="text-center py-8 bg-gray-50 rounded-lg"
                >
                  <Inbox class="h-10 w-10 mx-auto text-gray-300 mb-2" />
                  <p class="text-sm text-gray-500">
          ...
          <template v-else>
            <div>
              ...
              <div class="space-y-2">
                ...
                <div
                  v-if="!submissionReviewer.totalByRole || submissionReviewer.totalByRole.length === 0"
                  class="text-center py-8 bg-gray-50 rounded-lg"
                >
                  <Inbox class="h-10 w-10 mx-auto text-gray-300 mb-2" />
                  <p class="text-sm text-gray-500">
