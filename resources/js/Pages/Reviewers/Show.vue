                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        <div>
                            ...
                            >
                                {{ reviewer.user.name }}
                                <Badge :variant="getStatusInfo.variant" class="text-xs">
                                    {{ getStatusInfo.label }}
                                </Badge>
                            </h2>
                ...
                <CardContent class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <div>
                                <Badge :variant="getStatusInfo.variant" class="gap-1">
                    ...
                    <Table>
                        ...
                        <TableBody>
                            ...
                            >
                                ...
                                <TableCell>
                                    <Badge v-if="submission.evaluation_status" variant="default">
                                        {{ submission.evaluation_status }}
                                    </Badge>
                                    <Badge v-else variant="secondary"> Belum Dimulai </Badge>
                                </TableCell>
