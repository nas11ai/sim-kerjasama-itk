...
const form = useForm({
    reviewer_type: props.reviewer.reviewer_type,
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Reviewer</h2>
            </div>
        </template>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-yellow-700">
                                        <p>
                                            Memperbarui informasi reviewer dapat mempengaruhi proses
                                            review yang sedang berlangsung. Harap pastikan perubahan
                                            ini diperlukan dan dikoordinasikan dengan pemangku
                                            kepentingan terkait.
                                        </p>
                                    </div>
                                </div>
