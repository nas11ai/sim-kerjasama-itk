    ...
    <div class="max-w-6xl mx-auto space-y-6">
      ...
      <Card v-if="reviewStats">
        ...
        <CardContent>
          ...
          <!-- Assigned Reviewers -->
          <div
            v-if="submission.assigned_reviewers?.length"
      ...
      <Card>
        ...
        <CardContent>
          <div
            v-if="submission.form?.form_fields?.length"
            class="space-y-4"
          >
            <div
    ...
    <Dialog v-model:open="showStatusModal">
      <DialogContent class="sm:max-w-lg">
        ...
        <div class="space-y-4 py-4">
          ...
          <div
            v-if="selectedStatus"
            class="bg-muted/50 p-3 rounded-lg"
          >
