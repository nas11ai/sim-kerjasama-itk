            ...
            <form class="space-y-6" @submit.prevent="submit">
                                            ...
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div class="flex-1 space-y-4">
                                                    <div class="grid gap-4 md:grid-cols-2">
                                                        <!-- Form Access Control -->
                                                        <div class="space-y-2">
                                                            <Label>Akses Kontrol Formulir *</Label>
                                                            <Select
                                                                v-model="
                ...
                <div class="flex items-center justify-end space-x-2">
                    ...
                    <Button type="submit" :disabled="form.processing">
                        {{ form.processing ? 'Memperbarui...' : 'Perbarui Tahap Formulir' }}
                    </Button>
                </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-amber-700 text-sm">
                                    Mengubah detail fase akan memengaruhi semua pengguna yang
                                    memiliki akses ke fase ini. Pastikan untuk berkoordinasi dengan
                                    pemangku kepentingan terkait sebelum melakukan perubahan.
                                </p>
                            </div>
                        </div>
                    </CardContent>
