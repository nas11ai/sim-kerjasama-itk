        ...
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="flex items-center gap-2">
                        <Users class="h-5 w-5" />
                        Detail Tahap ({{ groupedPhaseDetails.length }} Formulir, {{ sortedPhaseDetails.length }} Akses Kontrol)
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    <!-- Empty State -->
                            ...
                            >
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="font-semibold text-lg">{{ group.formTitle }}</span>
                                    </div>
                                            ...
                                            >
                                                <div class="flex items-center justify-between mb-2">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <Badge v-if="detail.needs_review" variant="destructive" class="text-xs">
                                                            Perlu Review
                                                        </Badge>
                                                    </div>
                                                </div>
                                                <div class="space-y-1 text-sm">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <span class="font-medium">{{ detail.form_access_control.role.name }}</span>
                                                    </div>
                                                    <div class="flex items-center gap-2">
                                                ...
                                                <div v-if="getEvaluationFormsForDetail(detail).length > 0" class="mt-2 pt-2 border-t">
                                                    <div class="flex items-center justify-between">
                                                        <span class="text-xs text-muted-foreground flex items-center gap-1">
                                                            <ClipboardList class="h-3 w-3" />
                                                            {{ getEvaluationFormsForDetail(detail).length }} Formulir Evaluasi
                                                        </span>
                                                        <Link
