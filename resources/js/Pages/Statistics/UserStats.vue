        ...
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <Button variant="outline" @click="router.visit(route('admin.stats.index'))">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                <Card>
                    <CardHeader>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle> User Terbaru (24 Jam Terakhir) </CardTitle>
                                    <CardDescription>
                    ...
                    <CardContent>
                        <div v-if="recentUserTotal === 0" class="text-center text-gray-500 py-6">
                            Tidak ada aktivitas user terbaru dalam 24 jam terakhir.
                        </div>
                        <div v-else class="space-y-4 max-h-96 overflow-y-auto p-2">
                            <div
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex flex-row gap-3 items-center">
                                <div
                                    class="h-10 w-10 bg-purple-100 rounded-lg flex items-center justify-center"
                                >
                                    <ChartColumn class="h-5 w-5 text-purple-600" />
                                </div>
                                <div>
                                    <CardTitle> Distribusi Grafik User </CardTitle>
                        ...
                        <div v-else>
                            <div class="flex justify-center items-center h-full">
                                <DonutChart
                                    ...
                                    :value-formatter="
                                        (valueFormatter) => `Total ${valueFormatter} Users`
                                    "
                                    class="h-[256px]"
                                />
                                <BarChart
                                    ...
                                    index="name"
                                    :categories="['total']"
                                    :y-formatter="(valueFormatter) => `${valueFormatter} Users`"
                                />
                            </div>
                        </div>
                    </CardContent>
