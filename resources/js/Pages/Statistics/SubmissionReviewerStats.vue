...
const evaluationStatusData = computed(() => {
    return (
        props.evaluationStatus?.map((item) => ({
            name:
                item.evaluation_status.charAt(0).toUpperCase() +
                item.evaluation_status.slice(1).replace('_', ' '),
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <CardDescription
                                    >Reviewer yang baru ditambahkan dalam sistem</CardDescription
                                >
                            </div>
                        </div>
                    ...
                    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        >
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500">ID: {{ reviewer.user_id }}</p>
                            </div>
                        </div>
                    </div>
                </CardContent>
                                ...
                                <div class="flex items-center justify-between flex-wrap gap-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <CardDescription
                                                >Distribusi status evaluasi saat
                                                ini</CardDescription
                                            >
                                        </div>
                                    </div>
                            ...
                            <CardContent>
                                ...
                                <div v-else>
                                    ...
                                    <BarChart
                                        ...
                                        :categories="['total']"
                                        :y-formatter="
                                            (valueFormatter) => `${valueFormatter} Evaluations`
                                        "
                                    />
                                </div>
                            </CardContent>
                            ...
                            <CardHeader>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription
                                            >Rincian berdasarkan status evaluasi</CardDescription
                                        >
                                    </div>
                                </div>
                            </CardHeader>
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription
                                            >Distribusi reviewer berdasarkan berbagai
                        ...
                        <CardContent>
                            ...
                            <div v-else>
                                <DonutChart
                                    ...
                                    :category="'total'"
                                    :value-formatter="
                                        (valueFormatter) => `Total ${valueFormatter} Reviewers`
                                    "
                                    class="h-[256px]"
                                />
                                <BarChart
                                    ...
                                    index="name"
                                    :categories="['total']"
                                    :y-formatter="(valueFormatter) => `${valueFormatter} Reviewers`"
                                />
                            </div>
                        </CardContent>
                    </Card>
                                ...
                                <p class="text-gray-500">
                                    {{
                                        selectedFaculties.length === 0
                                            ? 'Silakan pilih setidaknya satu fakultas'
                                            : 'Tidak ada data fakultas tersedia'
                                    }}
                                </p>
                            </div>
                            <div v-else>
                                ...
                                <p class="text-gray-500">
                                    {{
                                        selectedStudyPrograms.length === 0
                                            ? 'Silakan pilih setidaknya satu program studi'
