...
const prevSlide = () => {
    if (announcementsData.length > 0) {
        currentSlide.value = currentSlide.value === 0 ? announcementsData.length - 1 : currentSlide.value - 1;
    }
};
                    ...
                    <div class="space-y-8">
                        <div class="space-y-6">
                            ...
                            <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
                                Mengelola dan membangun kemitraan strategis untuk kemajuan Institut Teknologi Kalimantan
                            </p>
                        </div>
        ...
        <section id="announcements"
            ...
            <div class="w-full h-full flex flex-col justify-center py-16">
                ...
                <div class="px-4 sm:px-6 lg:px-8 text-center mb-12">
                    <Badge class="mb-4 px-4 py-2 text-sm">
                        Informasi Terkini
                    </Badge>
                ...
                <div v-if="announcementsData.length > 0" class="flex-1 relative px-4 sm:px-6 lg:px-8">
                    <div class="max-w-5xl mx-auto h-full relative flex items-center">
                                        ...
                                        <CardContent class="p-8 space-y-6">
                                            ...
                                            <div class="pt-4">
                                                <Button as-child size="lg" class="gap-2 group">
                                                    <Link :href="route('announcements.detail', announcement.id)">
                                                    Lihat Selengkapnya
                                                    <ArrowRight
                        ...
                        <!-- Navigation Buttons -->
                        <button v-if="announcementsData.length > 1" @click="prevSlide(); resetAutoPlay();"
                        ...
                        <button v-if="announcementsData.length > 1" @click="nextSlide(); resetAutoPlay();"
                        ...
                        <div class="max-w-5xl mx-auto flex items-center justify-between">
                            ...
                            <div v-if="announcementsData.length > 1" class="flex justify-center gap-2 flex-1">
                                <button v-for="(announcement, index) in announcementsData"
                                    :key="`indicator-${announcement.id}`" @click="goToSlide(index)"
