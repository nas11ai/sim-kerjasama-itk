        ...
        <div class="max-w-6xl mx-auto space-y-6">
            ...
            <Card>
                <CardContent class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        <div v-for="step in steps" :key="step.number" @click="goToStep(step.number)" :class="[
            ...
            <Card>
                ...
                <CardContent class="min-h-[400px]">
                    <Step1BasicForm v-if="currentStep === 1" v-model="form.form" :form-types="formTypes"
                        :field-types="fieldTypes" :errors="form.errors" />

                    <Step2AccessControl v-if="currentStep === 2" v-model="form.access_controls" :roles="roles"
                        :faculties="faculties" :errors="form.errors" />

                    <Step3FormPhase v-if="currentStep === 3" v-model="form.phase" :form-phases="formPhases"
                        :phase-types="phaseTypes" :errors="form.errors" />

                    <Step4ReviewSettings v-if="currentStep === 4" v-model="form.evaluation_forms"
                        :needs-review="form.phase.needs_review" :field-types="fieldTypes" :errors="form.errors"
                        @update:needs-review="form.phase.needs_review = $event" />

                    <Step5SubmissionPeriod v-if="currentStep === 5" v-model="form.submission_period"
                        :submission-periods="submissionPeriods" :errors="form.errors" />

                    <Step6Review v-if="currentStep === 6" :form-data="form" :form-types="formTypes" :roles="roles"
                        :faculties="faculties" :phase-types="phaseTypes" :form-phases="formPhases"
