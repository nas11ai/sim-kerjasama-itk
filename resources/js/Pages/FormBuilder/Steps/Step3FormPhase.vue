    ...
    <Card v-if="phaseData.use_existing">
      ...
      <CardContent class="space-y-4">
        <div class="space-y-2">
          ...
          <p
            v-if="errors['phase.existing_phase_id']"
        ...
        >
          <CardContent class="p-4">
            <div class="space-y-2">
              ...
              <p
                v-if="selectedPhaseInfo.description"
    ...
    <Card v-else>
      ...
      <CardContent class="space-y-4">
        <div class="space-y-2">
          ...
          />
          <p
            v-if="errors['phase.new_phase_title']"
            class="text-sm text-destructive"
          >
    ...
    <Card>
      ...
      <CardContent class="space-y-4">
        <div class="space-y-2">
          ...
          <p
            v-if="errors['phase.phase_type_id']"
            class="text-sm text-destructive"
          >
        ...
        <div class="flex items-center space-x-2 p-4 border rounded-lg">
          <Switch
            id="needs_review"
            v-model="phaseData.needs_review"
          />
          <Label
            for="needs_review"
            class="flex-1"
