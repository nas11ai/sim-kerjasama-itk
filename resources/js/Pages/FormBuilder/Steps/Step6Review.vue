...
<template>
  <div class="space-y-6">
    ...
    >
      ...
      <AlertDescription>
        <div class="font-medium mb-2">
          Silakan perbaiki masalah berikut:
        </div>
    ...
    <Card>
      ...
      <CardContent class="space-y-3">
        ...
        <div>
          ...
          <div
            v-if="formData.form.fields.length > 0"
            class="space-y-2"
          >
            <div
    ...
    <Card>
      ...
      <CardContent>
        <div
          v-if="formData.access_controls.length > 0"
          class="space-y-2"
        >
          <div
    ...
    <Card v-if="formData.phase.needs_review">
      ...
      <CardContent>
        <div
          v-if="formData.evaluation_forms.length > 0"
          class="space-y-3"
        >
          <div
