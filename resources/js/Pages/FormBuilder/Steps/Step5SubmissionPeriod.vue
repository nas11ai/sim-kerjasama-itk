...
const selectedPeriodInfo = computed(() => {
    if (!submissionPeriodData.value.use_existing || !submissionPeriodData.value.existing_period_id)
        return null
    return props.submissionPeriods.find(
        (p) => p.id === submissionPeriodData.value.existing_period_id
    )
})
    ...
    <div class="space-y-6">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >Pilih untuk menggunakan periode yang sudah ada atau membuat yang
            ...
            <CardContent class="space-y-4">
                <RadioGroup v-model="useExistingString" class="space-y-3">
                    <div
                        ...
                        :class="
                            submissionPeriodData.use_existing ? 'border-primary bg-primary/5' : ''
                        "
                        @click="submissionPeriodData.use_existing = true"
                    >
                        <RadioGroupItem id="use_existing_period" value="true" />
                    ...
                    >
                        <RadioGroupItem id="create_new_period" value="false" />
                            ...
                            >
                                ...
                                >
                                    <span class="text-blue-700 font-medium"
                                        >{{ date.submission_date_label?.name || 'Tanggal' }}:</span
                                    >
            ...
            <Card>
                <CardHeader>
                    <div class="flex items-center justify-between">
                        ...
                        <Button type="button" size="sm" variant="outline" @click="addDate">
                ...
                <CardContent>
                    ...
                    >
                        ...
                        <p>
                            Belum ada tanggal yang ditambahkan. Klik "Tambah Tanggal" untuk mengatur
                            jadwal pengajuan.
                        </p>
                    </div>
                                    ...
                                    <div class="flex-1 grid gap-4 md:grid-cols-2">
                                        <div class="space-y-2">
                                            ...
                                            <Select v-model="date.label_id">
                                                <SelectTrigger>
                                                    <SelectValue
                                                        placeholder="Pilih label tanggal"
                                                    />
                                                </SelectTrigger>
                                                <SelectContent>
                                                    <SelectItem
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <Input v-model="date.date" type="datetime-local" />
                                        </div>
                                    </div>
                                ...
                                <div v-if="date.label_id && date.date" class="mt-3 pt-3 border-t">
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <span class="font-medium"
                                            >{{ getLabelName(date.label_id) }}:</span
                                        >
                    ...
                    <div class="grid gap-2 text-sm">
                        <div class="flex items-center justify-between">
                            ...
                            <Badge variant="outline" class="text-green-700">
                                {{
                                    submissionPeriodData.use_existing
                        ...
                        <div
                            v-if="
                                !submissionPeriodData.use_existing &&
                                submissionPeriodData.new_period_name
                            "
                            class="flex items-center justify-between"
                        >
