...
const updateFilters = (newFilters: Partial<Filters>) => {
    router.get(
        route('admin.faculties.study-programs'),
        {
            ...props.filters,
            ...newFilters,
        },
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <Button variant="outline" @click="router.visit(route('admin.faculties.index'))">
                                            ...
                                            <DropdownMenuContent align="end">
                                                <DropdownMenuItem
                                                    @click="
                                                        router.visit(
                                                            route(
                                                                'admin.faculties.study-programs.edit',
                                                                program.id
                                                            )
                                                        )
                                                    "
                    ...
                    >
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <Button
                                ...
                                @click="
                                    goToPage(
                                        studyPrograms.links[studyPrograms.links.length - 1].url
                                    )
                                "
                            >
                                Halaman Selanjutnya
        ...
        <Dialog v-model:open="showDeleteDialog">
            <DialogContent class="sm:max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Apakah Anda yakin ingin menghapus program studi ini? Tindakan ini tidak
                        dapat dibatalkan.
                    </DialogDescription>
                </DialogHeader>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-muted-foreground mt-2">
                                    Dibuat pada:
                                    {{
                                        new Date(prodiToDelete.created_at).toLocaleDateString(
                                            'id-ID',
                                            {
                                                year: 'numeric',
                                                month: 'long',
                    ...
                    <div class="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                        <div class="flex items-start gap-2">
                            ...
                            <div class="text-sm text-yellow-800">
                                ...
                                <p>
                                    Menghapus program studi ini akan menghapus semua data terkait
                                    yang berhubungan dengan program studi ini.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <DialogFooter>
                    <Button variant="outline" :disabled="isDeleting !== null" @click="cancelDelete">
                        Batal
                    </Button>
                    <Button
                        variant="destructive"
