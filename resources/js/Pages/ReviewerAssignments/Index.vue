...
const sortedAssignments = computed(() => {
    return [...props.assignments.data].sort((a, b) => {
        ...
        return urgencyOrder[urgencyA.level as UrgencyLevel] - urgencyOrder[urgencyB.level as UrgencyLevel];
    });
});
</script>
                    ...
                    <div class="flex gap-4 items-end">
                        <div class="flex-1">
                            ...
                            <div class="relative">
                                ...
                                <Input v-model="searchTerm" placeholder="Search evaluation forms or submissions..."
                ...
                <CardContent>
                    <div v-if="sortedAssignments.length === 0" class="text-center py-12">
                        ...
                        <p class="text-muted-foreground">
                            No evaluation assignments match your current filters or you haven't been assigned any yet.
                        </p>
                    </div>
                    ...
                    <div v-else>
                        <Table>
                            ...
                            <TableBody>
                                <TableRow v-for="assignment in sortedAssignments" :key="assignment.id">
                                    <TableCell>
                                        <div>
                                            ...
                                            <div class="flex items-center gap-2 mt-1">
                                                <Badge v-if="assignment.is_required" variant="destructive"
                                                    class="text-xs">
                                                    Required
                                                </Badge>
                                    ...
                                    <TableCell>
                                        <div>
                                            <div class="font-medium">{{
                                                assignment.submission_reviewer.form_submission.form.title }}</div>
                                    ...
                                    <TableCell>
                                        <Badge :class="getStatusInfo(assignment).color">
                                            <component :is="getStatusInfo(assignment).icon" class="h-3 w-3 mr-1" />
                                            {{ getStatusInfo(assignment).label }}
                                        </Badge>
                                    </TableCell>
                                    <TableCell>
                                        <div v-if="assignment.due_date">
                                            <div class="text-sm">{{ formatDate(assignment.due_date) }}</div>
                                        </div>
                                    ...
                                    <TableCell>
                                        <Badge v-if="getUrgencyLevel(assignment)"
                                            :class="getUrgencyLevel(assignment)!.color" class="text-xs">
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            <div class="text-sm text-muted-foreground">
                                Showing {{ assignments.meta.from || 0 }} to {{ assignments.meta.to || 0 }}
                                of {{ assignments.meta.total }} results
                            </div>

                            <div class="flex gap-2">
                                <Link v-for="link in assignments.links" :key="link.label" :href="link.url"
