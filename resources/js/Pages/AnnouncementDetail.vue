        ...
        <div class="max-w-3xl mx-auto py-8 space-y-6">
            <div class="border-b pb-4 mb-4">
                ...
                <div class="text-sm text-gray-500 flex gap-4 mt-2">
                    ...
                    <span
                        >Created by:
                        {{ props.announcement.created_by?.name }}</span
                    >
                    <span
                        >Created at:
                        {{
                    ...
                    >
                    <span v-if="props.announcement.expired_at"
                        >Expired at:
                        {{
                            new Date(
                                props.announcement.expired_at
                            ).toLocaleDateString()
                        }}</span
                    >
                </div>
            ...
            <div
                ...
                v-html="props.announcement.content"
            ></div>

            <div
                v-if="
                    props.announcement.files &&
                    props.announcement.files.length > 0
                "
                class="mt-6"
            >
