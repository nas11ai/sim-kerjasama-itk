    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Button :disabled="!props.can.create" @click="showCreateModal = true">
            ...
            >
                <template #delete-dialog-content>
                    <p class="text-muted-foreground text-sm">
                        Apakah Anda yakin ingin menghapus <strong>hak akses</strong> ini? Tindakan
                        ini tidak dapat dibatalkan. Ini akan menghapus data secara permanen.
                    </p>
                </template>
            </DataTable>
            <EditDialogue
