...
const groupedForms = computed((): GroupedForm[] => {
    ...
    // Sort by order
    const sortedControls = [...props.formPhase.form_access_controls].sort(
        (a, b) => a.order - b.order
    )
...
const submitForm = () => {
    ...
    router.post(route('user.form-submission.submit'), payload, {
        onSuccess: () => {
            if (
                canGoNext.value &&
                currentFormAccessControl.value &&
                !currentFormAccessControl.value.needs_review
            ) {
                nextStep()
            } else {
...
const isStepPendingReview = (stepIndex: number) => {
    const group = groupedForms.value[stepIndex]
    return (
        group?.userSubmission?.is_submitted &&
...
const renderFormField = (field: FormField) => {
    ...
    switch (fieldType) {
        case 'text':
            return {
                component: 'Input',
                props: { type: 'text', placeholder: `Masukkan ${field.label.toLowerCase()}...` },
            }
        case 'email':
            return {
                component: 'Input',
                props: { type: 'email', placeholder: `Masukkan alamat email...` },
            }
        case 'number':
            return {
                component: 'Input',
                props: { type: 'number', placeholder: `Masukkan ${field.label.toLowerCase()}...` },
            }
        case 'url':
        ...
        case 'phone':
            return {
                component: 'Input',
                props: { type: 'tel', placeholder: `Masukkan nomor telepon...` },
            }
        case 'date':
        ...
        case 'textarea':
            return {
                component: 'Textarea',
                props: { placeholder: `Masukkan ${field.label.toLowerCase()}...`, rows: 4 },
            }
        case 'select':
        ...
        <div class="max-w-6xl mx-auto space-y-6">
            ...
            <div class="grid gap-6 lg:grid-cols-12">
                ...
                <div class="lg:col-span-9">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-green-700">
                                                ...
                                                {{
                                                    new Date(
                                                        currentFormAccessControl.user_submission
                                                            .created_at
                                            ...
                                            <p
                                                v-if="
                                                    currentFormAccessControl.needs_review &&
                                                    !currentFormAccessControl.user_submission
                                                        .can_proceed
                                                "
                                                class="text-sm text-yellow-700 mt-1"
                                            >
                                                Form sedang dalam proses review. Anda tidak dapat
                                                melanjutkan ke step selanjutnya sampai review
                                                selesai.
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <Card
                        v-if="
                            currentStepIndex >= totalSteps - 1 && isStepCompleted(currentStepIndex)
                        "
                    >
                        <CardContent class="text-center py-12">
                            ...
                            <p class="text-muted-foreground mb-6">
                                Anda telah menyelesaikan semua formulir dalam tahap "{{
                                    formPhase.title
                                }}".
                            </p>
