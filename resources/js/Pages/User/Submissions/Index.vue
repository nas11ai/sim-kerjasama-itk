    ...
    <AuthenticatedLayout>
        ...
        <div class="space-y-6">
            ...
            <div v-else class="space-y-6">
                <div v-for="period in submissionPeriods.filter(p => p.user_submissions_count > 0)" :key="period.id"
                    class="space-y-4">
                                ...
                                <div v-if="period.submission_dates.length > 0">
                                    ...
                                    <div class="grid gap-2 sm:grid-cols-2">
                                        <div v-for="date in period.submission_dates.slice(0, 4)" :key="date.id"
                                            ...
                                            <div class="font-medium">{{ date.submission_date_label.name }}</div>
                                            <div class="text-muted-foreground">{{ formatDateTime(date.datetime) }}</div>
                                        </div>
                                    </div>
                                </div>
