          ...
          <CardContent class="space-y-6">
            <div class="grid gap-6 md:grid-cols-2">
              ...
              <div class="space-y-2">
                ...
                <p
                  v-if="errors.form_phase_detail_id"
                  class="text-sm text-destructive"
                >
                    ...
                    <CardContent class="pt-6">
                      <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 space-y-4">
                          ...
                          <!-- Validation Rules -->
                          <div
                            v-if="isTextualField(field.field_type_id) || isNumericField(field.field_type_id)"
                            class="space-y-3"
                          >
                            ...
                            <div
                              v-if="isTextualField(field.field_type_id)"
                            ...
                            <div
                              v-if="isNumericField(field.field_type_id)"
                              class="grid gap-3 md:grid-cols-2"
                            >
                              <div class="space-y-2">
                          ...
                          <!-- Field Options -->
                          <div
                            v-if="fieldTypeRequiresOptions(field.field_type_id)"
                            class="space-y-3"
                          >
                            <div class="flex items-center justify-between">
                          ...
                          >
                            ...
                            <div class="space-y-2">
                              ...
                              <div class="mt-2">
                                ...
                                <div
                                  v-else-if="fieldTypeRequiresOptions(field.field_type_id) &&
                                ...
                                >
                                  <div class="space-y-2">
                                    ...
                                    >
                                      <input
                                        :type="getFieldTypeName(field.field_type_id) === 'checkbox'
                                          ? 'checkbox' : 'radio'"
                                        disabled
                                        class="h-4 w-4"
                                      >
                                ...
                                <div v-else>
                                  <Input
                                    :type="getFieldTypeName(field.field_type_id)"
                                    placeholder="Ini adalah pratinjau"
                                    disabled
                                  />
                                </div>
