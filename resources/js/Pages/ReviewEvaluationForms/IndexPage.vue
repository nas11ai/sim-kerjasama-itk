                ...
                <CardContent>
                    <div v-if="evaluationForms.data.length === 0" class="text-center py-12">
                        ...
                        <p class="text-muted-foreground mb-4">
                            Tidak ada formulir evaluasi yang sesuai dengan filter Anda saat ini atau
                    ...
                    <div v-else>
                                    ...
                                    <TableCell>
                                        <div>
                                            ...
                                            <div class="text-xs text-muted-foreground mt-1">
                                                Wajib:
                                                {{
                                                    form.review_form_fields.filter(
                                                        (f) => f.is_required
                                                    ).length
                                                }}
                                            </div>
                                            ...
                                            <DropdownMenuContent align="end">
                                                <DropdownMenuItem as-child>
                                                    <Link
                                                        :href="
                                                            route(
                                                                'admin.review-evaluation-forms.show',
                                                                form.id
                                                            )
                                                        "
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            <div class="text-sm text-muted-foreground">
                                Menampilkan {{ evaluationForms.meta.from || 0 }} hingga
                                {{ evaluationForms.meta.to || 0 }} dari
                                {{ evaluationForms.meta.total }} hasil
                            </div>
