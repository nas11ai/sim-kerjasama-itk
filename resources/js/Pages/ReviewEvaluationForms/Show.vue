        ...
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">Formulir Evaluasi Review</p>
                </div>
            </div>
        </template>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="flex flex-wrap gap-2 mt-2">
                                    <Badge
                                        :variant="
                                            evaluationForm.is_active ? 'default' : 'secondary'
                                        "
                                    >
                                    ...
                                    <Badge
                                        :variant="
                                            evaluationForm.is_required ? 'destructive' : 'outline'
                                        "
                                    >
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium">{{
                                            evaluationForm.review_form_fields.length
                                        }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span>Isian Wajib:</span>
                                        <span class="font-medium">{{
                                            evaluationForm.review_form_fields.filter(
                                                (f) => f.is_required
                                            ).length
                                        }}</span>
                                    </div>
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        ...
                        <div class="text-center p-4 bg-green-50 rounded-lg">
                            <div class="text-2xl font-bold text-green-600">
                                {{ assignmentStats.completed_responses }}
                            </div>
                            <div class="text-sm text-green-700">Respon Selesai</div>
                        </div>
                        <div class="text-center p-4 bg-orange-50 rounded-lg">
                            <div class="text-2xl font-bold text-orange-600">
                                {{ assignmentStats.pending_responses }}
                            </div>
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div v-else class="space-y-6">
                        <div
                            v-for="(field, index) in evaluationForm.review_form_fields"
                            :key="field.id"
                        ...
                        >
                            ...
                            <div class="grid gap-4 md:grid-cols-2 text-sm">
                                ...
                                <div>
                                    ...
                                    <span class="ml-2">{{
                                        formatValidationRules(field.validation_rules)
                                    }}</span>
                                </div>
                            </div>
                            ...
                            <!-- Field Options -->
                            <div
                                v-if="field.review_form_field_options.length > 0"
                            ...
                            >
                                ...
                                <div class="grid gap-2 md:grid-cols-2">
                                    ...
                                    >
                                        ...
                                        <span
                                            v-if="option.value && option.value !== option.label"
                            ...
                            <div class="mt-4 pt-4 border-t bg-muted/30 p-3 rounded">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="mt-2">
                                        <div
                                            v-if="field.field_type.name === 'textarea'"
                                        ...
                                        >
                                            <div class="space-y-1">
                                                <div
                                                    v-for="option in field.review_form_field_options.slice(
                                                        0,
                                                        3
                                                    )"
                                                    :key="option.id"
                                                ...
                                                <div
                                                    v-if="
                                                        field.review_form_field_options.length > 3
                                                    "
                            ...
                            <Separator
                                v-if="index < evaluationForm.review_form_fields.length - 1"
                                class="mt-6"
                            />
                        </div>
                    </div>
                        ...
                        <div class="flex gap-2">
                            <Button
                                ...
                                @click="
                                    $inertia.post(
                                        route(
                                            'admin.review-evaluation-forms.duplicate',
                                            evaluationForm.id
                                        )
                                    )
                                "
