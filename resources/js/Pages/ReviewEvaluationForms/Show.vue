              ...
              <div class="mt-4 pt-4 border-t bg-muted/30 p-3 rounded">
                ...
                <div class="space-y-2">
                  ...
                  <div class="mt-2">
                    ...
                    <div
                      v-else-if="['select', 'radio', 'checkbox'].includes(field.field_type.name) &&
                        field.review_form_field_options.length > 0"
                    >
                      <div class="space-y-1">
                        <div
                          v-for="option in field.review_form_field_options.slice(0, 3)"
                          :key="option.id"
                          class="flex items-center space-x-2"
                        >
                          <input
                            :type="field.field_type.name === 'checkbox' ? 'checkbox' :
                              field.field_type.name === 'radio' ? 'radio' : 'text'"
                            disabled
                            class="h-3 w-3"
                          >
                        ...
                        <div
                          v-if="field.review_form_field_options.length > 3"
