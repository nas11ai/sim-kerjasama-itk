            ...
            <form class="space-y-6" @submit.prevent="submit">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        >
                            <p>
                                Belum ada isian evaluasi yang ditambahkan. Klik "Tambah Isian" untuk
                                memulai.
                            </p>
                        </div>
                                        ...
                                        <CardContent class="pt-6">
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div class="flex-1 space-y-4">
                                                    ...
                                                    <div
                                                        v-if="
                                                            isTextualField(field.field_type_id) ||
                                                            isNumericField(field.field_type_id)
                                                        "
                                                        class="space-y-3"
                                                    >
                                                        <Label class="text-sm font-medium"
                                                            >Aturan Validasi</Label
                                                        >
