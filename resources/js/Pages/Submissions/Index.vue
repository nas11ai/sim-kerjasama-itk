    ...
    <AuthenticatedLayout>
        ...
        <div class="space-y-6">
            ...
            <div v-else class="grid gap-6 lg:grid-cols-2">
                <Card v-for="period in props.submissionPeriods.data" :key="period.id"
                        ...
                        <div class="space-y-4">
                            ...
                            <div v-if="period.submission_dates.length > 0">
                                ...
                                <div class="grid gap-2">
                                    <div v-for="date in period.submission_dates.slice(0, 2)" :key="date.id"
                                        ...
                                        <span class="font-medium">{{ date.submission_date_label.name }}</span>
                                        <span class="text-muted-foreground">{{ formatDateTime(date.datetime) }}</span>
                                    </div>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div class="text-center p-3 bg-blue-50 rounded-lg">
                                    <div class="text-xl font-bold text-blue-600 flex items-center justify-center gap-1">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="w-full bg-muted rounded-full h-2">
                                    <div class="bg-green-600 h-2 rounded-full transition-all duration-300"
                                        :style="{ width: `${getApprovalRate(period.approved_submissions, period.total_submissions)}%` }">
                                    </div>
                                </div>
                            </div>
            ...
            <div v-if="props.submissionPeriods.links.length > 3" class="flex justify-center">
                <nav class="flex items-center space-x-1">
                    <Link v-for="link in props.submissionPeriods.links" :key="link.label" :href="link.url" :class="[
